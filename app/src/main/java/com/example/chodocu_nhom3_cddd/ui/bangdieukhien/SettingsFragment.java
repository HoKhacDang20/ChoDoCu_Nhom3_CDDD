...
import com.example.chodocu_nhom3_cddd.data_models.CuocHen;
import com.example.chodocu_nhom3_cddd.data_models.DatHang;
import com.example.chodocu_nhom3_cddd.data_models.RemoveSanPham;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(sUserName != ""){
            ...
            databaseReference.child("User").addChildEventListener(new ChildEventListener() {
                @Override
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    if (snapshot.getValue(UserData.class).getUserID().equals(sUserName)) {
                        ...
                        sUserName = snapshot.getValue(UserData.class).getUserID();
                        ...
                        databaseReference.child("XoaSanPham").addChildEventListener(new ChildEventListener() {
                            @Override
                            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                if (snapshot.getValue(RemoveSanPham.class).getSanPham().getUserID().equals(sUserName)) {
                        ...
                        databaseReference.child("Comment").addChildEventListener(new ChildEventListener() {
                            @Override
                            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                if (snapshot.getValue(DatHang.class).getNguoiMuaID().equals(sUserName)) {
                        ...
                        databaseReference.child("DonHang").addChildEventListener(new ChildEventListener() {
                            @Override
                            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                if (snapshot.getValue(DatHang.class).getNguoiMuaID().equals(sUserName) && snapshot.getValue(DatHang.class).getTinhTrang() != 7) {
                                    donMuaArrayList.add(snapshot.getValue(DatHang.class));
                                } else if (snapshot.getValue(DatHang.class).getNguoiBanID().equals(sUserName) && snapshot.getValue(DatHang.class).getTinhTrang() < 7) {
                        ...
                        databaseReference.child("MoneyIncome").addChildEventListener(new ChildEventListener() {
                            @Override
                            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                if (snapshot.getValue(DatHang.class).getNguoiBanID().equals(sUserName)) {
            ...
            databaseReference.child("CuocHen").addChildEventListener(new ChildEventListener() {
                @Override
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    if ((snapshot.getValue(CuocHen.class).getNguoiDuocHenID().equals(sUserName) && snapshot.getValue(CuocHen.class).isActive()) || snapshot.getValue(CuocHen.class).getNguoiHenID().equals(sUserName)) {
