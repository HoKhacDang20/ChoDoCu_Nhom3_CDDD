...
import com.example.chodocu_nhom3_cddd.databinding.UserMainLayoutBinding;
...
public class UserMainActivity extends AppCompatActivity {
    ...
    private UserMainLayoutBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = UserMainLayoutBinding.inflate(getLayoutInflater());
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_user_main_layout);
