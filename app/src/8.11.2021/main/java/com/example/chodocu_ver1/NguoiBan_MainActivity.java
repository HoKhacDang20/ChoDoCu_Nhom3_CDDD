...
public class NguoiBan_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nguoiban_main_layout);
                    ...
                    if(snapshot.getValue(UserData.class).getUserID().equals(userID)){
                        ...
                        storageReference.child(snapshot.getValue(UserData.class).getImage() + ".png").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                Glide.with(NguoiBan_MainActivity.this).load(uri).into(imgUser);
                            }
...
//                Toast.makeText(context, "Hinh anh khong ton tai!", Toast.LENGTH_SHORT).show();
                        ...
                        txtUserName.setText(snapshot.getValue(UserData.class).getHoTen());
    ...
    View.OnClickListener doMoiClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    SanPhamAdapter sanPhamAdapter = new SanPhamAdapter(NguoiBan_MainActivity.this, R.layout.san_pham_adapter_layout, sanPhamArrayList);
