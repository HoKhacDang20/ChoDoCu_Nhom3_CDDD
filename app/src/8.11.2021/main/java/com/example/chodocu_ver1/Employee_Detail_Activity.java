...
import com.example.chodocu_ver1.AdminMainActivity;
import com.example.chodocu_ver1.NhanVien_AdminActivity;
...
public class Employee_Detail_Activity extends AppCompatActivity {
                    ...
                    if (snapshot.getValue(UserData.class).getUserID().equals(userID)) {
                        storageReference.child(snapshot.getValue(UserData.class).getImage() + ".png").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                Glide.with(Employee_Detail_Activity.this).load(uri).into(imgNV);
                            }
